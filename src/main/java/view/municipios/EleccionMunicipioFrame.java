 ...
 */
public class EleccionMunicipioFrame extends javax.swing.JFrame {

    JTablaMunicipiosParaEleccion tabla;
    
    private static EleccionMunicipioFrame instance;
    
    
    public static EleccionMunicipioFrame getInstance() {
       if (instance == null) {
             instance = new EleccionMunicipioFrame();
       }
       return instance;
    
    }
     
    private EleccionMunicipioFrame() {
        initComponents();
        ...
        setLocationRelativeTo(null);
         ...
         addWindowListener( new WindowAdapter() {
                ...
                public void windowClosing( WindowEvent evt ) {
                    ...
                    try {
                        FichaCliente.getInstance(SingletonCliente.getInstance().getCliente().getId()).getTabla().actualizar();
                    } catch (Exception ex) {
                        Logger.getLogger(EleccionMunicipioFrame.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    public void actualizarTabla() {
            tabla = new JTablaMunicipiosParaEleccion();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EleccionMunicipioFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
