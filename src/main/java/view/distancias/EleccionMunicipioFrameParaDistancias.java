...
public class EleccionMunicipioFrameParaDistancias extends javax.swing.JFrame {

    JTablaMunicipiosParaEleccionDistancias tabla;
    private String origenODestino; // esta variable se usa para saber si el municipio que tenemos que modificar es 
    // el municipio de origen o el del destino, es decir, quien llama a este frame
    
    private static EleccionMunicipioFrameParaDistancias instance;
    
    
    public static EleccionMunicipioFrameParaDistancias getInstance() {
       if (instance == null) {
             instance = new EleccionMunicipioFrameParaDistancias();
       }
       return instance;
    ...
    private EleccionMunicipioFrameParaDistancias() {
        initComponents();
         ...
         addWindowListener(new WindowAdapter() {
                ...
                public void windowClosing( WindowEvent evt ) {
                    ...
                    try {
                        ...
                        Logger.getLogger(EleccionMunicipioFrameParaDistancias.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    public void actualizarTabla() {
            tabla = new JTablaMunicipiosParaEleccionDistancias();
    ...
    private void initComponents() {
        ...
        jLabel47.setText("LISTADO TOTAL DE MUNICIPIOS");
        ...
        jButton1.setText("Configurar municipios");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EleccionMunicipioFrameParaDistancias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
