 ...
 */
public class AveriasYSolucionesFrame extends javax.swing.JFrame {

    TableRowSorter rowSorter;
    List<Object> lista;
    private static AveriasYSolucionesFrame instance;
     
    
    
     
    private AveriasYSolucionesFrame() {
        initComponents();
        lista = new ArrayList<>();
        lista.addAll(SingletonAverias.getInstance().getLista());
        lista.addAll(SingletonSoluciones.getInstance().getLista());
        lista.addAll(SingletonNumRespuesta.getInstance().getLista());
        TablaAveriasYSoluciones.getInstance().mostrar(lista);
        rowSorter = new TableRowSorter(TablaAveriasYSoluciones.getInstance().getModel());
        TablaAveriasYSoluciones.getInstance().setRowSorter(rowSorter);
        jScrollPaneTabla.setViewportView(TablaAveriasYSoluciones.getInstance());
        setListenerFilter();
        setListenerComboTipos();
    ...
    public void actualizarTabla() {
                         if (jComboBoxFiltroPorTipo.getSelectedIndex() == 0) {
                            lista = new ArrayList<>();
                            lista.addAll(SingletonAverias.getInstance().getLista());
                            lista.addAll(SingletonSoluciones.getInstance().getLista());
                            lista.addAll(SingletonNumRespuesta.getInstance().getLista());
                        } 
                        if (jComboBoxFiltroPorTipo.getSelectedIndex() == 1) {
                             lista = new ArrayList<>();
                             lista.addAll(SingletonAverias.getInstance().getLista());
                        } 
                        if (jComboBoxFiltroPorTipo.getSelectedIndex() == 2) {
                           lista = new ArrayList<>();
                           lista.addAll(SingletonSoluciones.getInstance().getLista());
                        } 
                        if (jComboBoxFiltroPorTipo.getSelectedIndex() == 3) {
                            lista = new ArrayList<>();
                            lista.addAll(SingletonNumRespuesta.getInstance().getLista());
                          } 
                       TablaAveriasYSoluciones.getInstance().mostrar(lista);
    ...
    public void setListenerComboTipos() {
            
            jComboBoxFiltroPorTipo.addItemListener(new ItemListener(){
                    @Override
    ...
    private void initComponents() {
        ...
        jComboBoxFiltroPorTipo = new javax.swing.JComboBox<>();
        ...
        setTitle("AVERIAS, SOLUCIONES Y NºRESPUESTA");
        setExtendedState(6);
        ...
        jComboBoxFiltroPorTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "Averia", "Solucion", "Num Respuesta" }));

        jLabel1.setText("Filtrar por");

        jComboBoxFiltros.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tipo", "Codigo", "Descripción" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jComboBoxFiltroPorTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jComboBoxFiltroPorTipo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        panelContenedorLayout.setHorizontalGroup(
            ...
            .addComponent(jScrollPaneTabla, javax.swing.GroupLayout.Alignment.TRAILING)
        );
        panelContenedorLayout.setVerticalGroup(
            ...
            .addGroup(panelContenedorLayout.createSequentialGroup()
                ...
                .addGroup(panelContenedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jScrollPaneTabla, javax.swing.GroupLayout.DEFAULT_SIZE, 721, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jCheckBoxEdicion)
                .addGap(14, 14, 14))
        );
        ...
        jCheckBoxEdicion.addItemListener(new ItemListener() {
                    ...
                    public void itemStateChanged(ItemEvent e) {
                        ...
                        if (jCheckBoxEdicion.isSelected()) {
                                 TablaAveriasYSoluciones.getInstance().habilitarEdicionTabla();
                       
                        } else {
                                 TablaAveriasYSoluciones.getInstance().deshabilitarEdicionTabla();
    ...
    public static AveriasYSolucionesFrame getInstance() {
        if (instance == null) {
              instance = new AveriasYSolucionesFrame();
        }
        return instance;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AveriasYSolucionesFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<String> jComboBoxFiltroPorTipo;
