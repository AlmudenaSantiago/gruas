...
public class FichaGrua extends javax.swing.JFrame {
    ...
    public FichaGrua(Vehiculo vehiculo) {
    ...
    public void inicializarComboMarcas() {
          ...
          try {
                ...
                Logger.getLogger(FichaGrua.class.getName()).log(Level.SEVERE, null, ex);
           }
