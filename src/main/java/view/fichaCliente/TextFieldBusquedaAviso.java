...
/**  
 * @category JTextField con menú desplegable de coincidencias 
 * @version 1.0
...
public class TextFieldBusquedaAviso extends JTextField {
	...
	private boolean autocomplete;
        private AvisoFrame ficha;
        private HashMap hashContador;

	public TextFieldBusquedaAviso(AvisoFrame f, int widthPopupPanel , int heightPopupPanel , boolean autoComplete ){
        ...
        dataList.removeAll(dataList);
            try {
              ...
              List<Cliente> clientesBusqueda = SingletonClientes.getInstance().getLista();
                ...
                Logger.getLogger(TextFieldBusquedaAviso.class.getName()).log(Level.SEVERE, null, ex);
            }
