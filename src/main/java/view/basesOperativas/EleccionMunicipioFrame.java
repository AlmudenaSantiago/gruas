...
public class EleccionMunicipioFrame extends javax.swing.JFrame {
    ...
    TablaMunicipiosParaEleccion tabla;
         ...
         addWindowListener(new WindowAdapter() {
                ...
                public void windowClosing( WindowEvent evt ) {
                    ...
                    try {
                       ...
                       BasesOperativasCRUDFrame.getInstance().getTabla().mostrar(SingletonBasesOperativas.getInstance().getLista());
                    } catch (Exception ex) {
    ...
    public void actualizarTabla() {
            tabla = new TablaMunicipiosParaEleccion();
