...
public class CRUD_ClientesFrameReducida extends javax.swing.JFrame {


    private JScrollPane jScrollPane1;
    private CargarClientesCommand cargarClientesCommand;
    private JButton botonInsertar = new JButton("INSERTAR NUEVO");
    private static CRUD_ClientesFrameReducida instance;
    private Timer timer;
    ...
    private CRUD_ClientesFrameReducida() {
       ...
       rowSorter = new TableRowSorter(JTablaCRUDClientesReducida.getInstance().getModel());
       JTablaCRUDClientesReducida.getInstance().setRowSorter(rowSorter);
    ...
    public static CRUD_ClientesFrameReducida getInstance() { 
        if (instance == null) {
            instance = new CRUD_ClientesFrameReducida();
        }
        return instance;
    }
    ...
    private void initComponents() {
       ...
       // PRIMER PANEL  
        ...
        jScrollPane1.setViewportView(JTablaCRUDClientesReducida.getInstance());
    ...
    public void manejarCheck () {
    
     if (checkBoxBuscarPorNombre.isSelected())  {
         
     }
     
     if (checkBoxBuscarPorApellidos.isSelected())  {
         checkBoxBuscarPorNombre.setSelected(false);
         checkBoxBuscarPorNif.setSelected(false);
     }
   
     if (checkBoxBuscarPorNif.isSelected())  {
         checkBoxBuscarPorNombre.setSelected(false);
         checkBoxBuscarPorApellidos.setSelected(false);
     }
