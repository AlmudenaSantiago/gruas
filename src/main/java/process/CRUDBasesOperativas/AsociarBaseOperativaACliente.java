 ...
 * @author loquat
 */
public class AsociarBaseOperativaACliente {
    
    
    BaseOperativaAuxConClienteId baseOperativa;
    
    public AsociarBaseOperativaACliente(BaseOperativa base) {
    ...
    public void asociar () throws Exception {
        ...
        System.out.println("envio"  + stringJsonPasarela);
        String stringRespuestaPOST = conexionPOST(stringJsonPasarela);
        System.out.println("devuelve" + stringRespuestaPOST);
     ...
     private String conexionPOST(String datos) {
        ...
        try {
            // creamos la conexion
            url = new URL("http://localhost/gruas/gruas/api/asociarBaseOperativaACliente");
