...
public class EliminarBaseOperativa {

   BaseOperativa baseoperativa;
   
   
    public EliminarBaseOperativa(BaseOperativa baseoperativa) {
    ...
    public void eliminar () throws Exception {
     ...
     private String conexionPOST(String datos) {
        ...
        try {
            // creamos la conexion
            url = new URL("http://localhost/gruas/gruas/api/eliminarBaseOperativa");
