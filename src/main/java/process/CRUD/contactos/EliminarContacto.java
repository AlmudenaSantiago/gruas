...
public class EliminarContacto {
    ...
    Contacto  c;
    public EliminarContacto(Contacto c) {
       this.c = c;
    }
    ...
    public void elimina () throws Exception {
        ...
        if (stringRespuestaPOST == null)  JOptionPane.showMessageDialog (null,"Ha ocurrido un error al eliminar el contacto");
     ...
     private String conexionPOST(String datos) {
        ...
        try {
            // creamos la conexion
            url = new URL("http://localhost/gruas/gruas/api/eliminarContacto");
