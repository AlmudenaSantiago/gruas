...
public class EliminarNumRespuesta {
   ...
   NumRespuesta num;
    ...
    public void eliminar () throws Exception {
        ...
        if (stringRespuestaPOST == null)  JOptionPane.showMessageDialog (null,"No se ha podido eliminar el numero de respuesta. Ha ocurrido una excepción inesperada:  " + stringRespuestaPOST);
