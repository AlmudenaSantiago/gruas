...
public class EliminarSolucion {

   Solucion averia;
   
   
    public EliminarSolucion(Solucion averia) {
       this.averia = averia;
    }

    public void eliminar () throws Exception {
        SolucionParserJson parser = new SolucionParserJson();
        String stringjson = parser.devuelveJsonDeSolucion(averia);  
     ...
     private String conexionPOST(String datos) {
        ...
        try {
            // creamos la conexion
            url = new URL("http://localhost/gruas/gruas/api/eliminarSolucion");
