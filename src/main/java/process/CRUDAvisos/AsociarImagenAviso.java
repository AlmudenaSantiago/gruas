...
public class AsociarImagenAviso {

   Imagen imagen;
   
   
    public AsociarImagenAviso(Imagen imagen) {
       this.imagen = imagen;
    }

    public List<Aviso> asociar () throws Exception {
        ...
        if (stringRespuestaPOST == null) JOptionPane.showMessageDialog (null,"No se han podido asociar las imagenes. Ha ocurrido una excepción inesperada:  " + stringRespuestaPOST);
     ...
     private String conexionPOST(String datos) {
        ...
        try {
            // creamos la conexion
            url = new URL("http://localhost/gruas/gruas/api/asociarImagenAviso");
