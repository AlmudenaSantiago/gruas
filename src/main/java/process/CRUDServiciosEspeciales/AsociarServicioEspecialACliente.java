 ...
 * @author loquat
 */
public class AsociarServicioEspecialACliente {
    
    
    ServicioEspecial servicioEspecial;
    
    public AsociarServicioEspecialACliente(ServicioEspecial servicio) {
       servicioEspecial = new ServicioEspecial();
    ...
    public void asociar () throws Exception {
        ...
        String stringJsonPasarela = parser.devuelveJsonDeServicioEspecial(servicioEspecial);
     ...
     private String conexionPOST(String datos) {
        ...
        try {
            // creamos la conexion
            url = new URL("http://localhost/gruas/gruas/api/asociarServicioEspecialACliente");
