...
public class EliminarProveedor {
    ...
    Integer id;
    public EliminarProveedor(Integer id) {
       this.id = id;
    }
    ...
    public void eliminar () throws Exception {
        ...
        String stringJsonPedidoPasarela = new ProveedorParserJson().devuelveJsonDeProveedor(proveedor);  
        String stringRespuestaPOST = conexionPOST(stringJsonPedidoPasarela);
        if (stringRespuestaPOST.equals("ok"))  JOptionPane.showMessageDialog (null,"Proveedor eliminado correctamente");
     ...
     private String conexionPOST(String datos) {
        ...
        try {
            // creamos la conexion
            url = new URL("http://localhost/gruas/gruas/api/eliminarProveedor");
