...
public class ActualizarVariaciones {
    ...
    public ActualizarVariaciones(Integer idPedido, Integer idProducto, String variaciones) {
    ...
    public void actualizar () throws Exception {
     ...
     private String conexionPOST(String datos) {
        ...
        try {
            // creamos la conexion
            url = new URL("http://localhost/alca/alca/api/actualizarProductoPedidoVariaciones");
