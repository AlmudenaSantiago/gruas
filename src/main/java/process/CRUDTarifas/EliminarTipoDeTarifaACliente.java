 ...
 * @author loquat
 */
public class EliminarTipoDeTarifaACliente {
    
    
    TipoDeTarifaAuxConClienteID tipoDeTarifa;
    
    public EliminarTipoDeTarifaACliente(TipoDeTarifa tipoDeTarifa1, Integer idCliente) {
    ...
    public void eliminar () throws Exception {
     ...
     private String conexionPOST(String datos) {
        ...
        try {
            // creamos la conexion
            url = new URL("http://localhost/gruas/gruas/api/eliminarTipoDeTarifaACliente");
